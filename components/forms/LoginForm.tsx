        ...
        <div className="flex flex-col gap-6">
            <Card>
                <CardHeader className="text-center">
                    ...
                    <CardDescription>เข้าสู่ระบบด้วยบัญชี Google หรือ GitHub ของคุณ</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <div className="text-center text-xs text-muted-foreground text-balance">
                คลิกเพื่อดำเนินการต่อ ถือว่าคุณยอมรับ เงื่อนไขการให้บริการ และ นโยบายความเป็นส่วนตัว ของเรา
